...
type ListMacrosRq struct {
	Handler              string   `protobuf:"bytes,1,opt,name=handler,proto3" json:"handler,omitempty"`
	MacroName            []string `protobuf:"bytes,2,rep,name=macroName,proto3" json:"macroName,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ListMacrosRq) GetMacroName() []string {
	if m != nil {
		return m.MacroName
	}
	return nil
...
type ListMacrosResp struct {
	MacroName            []string `protobuf:"bytes,1,rep,name=macroName,proto3" json:"macroName,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ListMacrosResp) GetMacroName() []string {
	if m != nil {
		return m.MacroName
	}
	return nil
...
func (m *StatusMacroResp) GetStatus() string {
	if m != nil {
		return m.Status
	}
	return ""
...
var fileDescriptor_e8873c4c109c555c = []byte{
	...
	,
}
